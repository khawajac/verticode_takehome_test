...
export const dummyProjects: Project[] = [
...

  {
    ...
    description: 'Implementation of multiple payment options including credit cards, digital wallets, and buy-now-pay-later services. PCI compliance and fraud detection included.',
  ...
  },
  {
    ...
    description: 'Complete performance overhaul including image optimization, CDN implementation, lazy loading, and code splitting. Achieved 40% improvement in load times.',
    startDate: '2024-10-01',
    deadline: '2024-11-30',
    status: 'completed',
    createdAt: '2024-09-20T15:10:00Z'
  },
  {
    id: '13',
    name: 'User Authentication System',
    description: 'Modern authentication system with OAuth integration, two-factor authentication, password reset functionality, and session management.',
